      ...
      <div class="header-container">
        ...
        <div class="header-right">
          <div class="admin-info">
            <span class="welcome-text">Administrador</span>
          ...
          <div class="admin-actions">
            <button class="btn-icon" @click="toggleNotifications" title="Notificaciones">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                ...
                <path d="M13.73 21C13.5542 21.3031 13.3018 21.5547 12.9982 21.7295C12.6946 21.9044 12.3504 21.9965 12 21.9965C11.6496 21.9965 11.3054 21.9044 11.0018 21.7295C10.6982 21.5547 10.4458 21.3031 10.27 21" stroke="currentColor" stroke-width="2"/>
              </svg>
        ...
        <section class="dashboard-overview">
          ...
          <div class="stats-grid">
            ...
            <div class="stat-card staff">
              ...
              <div class="stat-content">
                <h3>{{ dashboardStats.activeStaff }}</h3>
                <p>Personal Activo</p>
                <span class="stat-change neutral">{{ dashboardStats.evaluators }} Evaluadores, {{ dashboardStats.collectors }} Cobradores</span>
              </div>
            </div>
            ...
            <div class="stat-card parameters">
              ...
              <div class="stat-content">
                <h3>{{ dashboardStats.systemParameters }}</h3>
                <p>Parámetros Configurados</p>
                <span class="stat-change neutral">Tasa actual: {{ dashboardStats.currentRate }}%</span>
              </div>
            </div>
            ...
            <div class="stat-card security">
              ...
              <div class="stat-content">
                <h3>{{ dashboardStats.auditLogs }}</h3>
          ...
          <div class="modules-grid">
            ...
            <div class="module-card" @click="navigateToModule('/admin/staff')">
              ...
              <div class="module-content">
                ...
                <div class="module-stats">
                  <span>{{ dashboardStats.activeStaff }} usuarios internos activos</span>
                </div>
              </div>
            ...
            <div class="module-card" @click="navigateToModule('/admin/parameters')">
              ...
              <div class="module-content">
                ...
                <div class="module-stats">
                  <span>{{ dashboardStats.systemParameters }} parámetros configurados</span>
                </div>
              </div>
              <div class="module-arrow">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
            ...
            <div class="module-card" @click="navigateToModule('/admin/article-types')">
              ...
              <div class="module-content">
                ...
                <div class="module-stats">
                  <span>Joyería, Electrónicos, Vehículos, etc.</span>
                </div>
              </div>
              <div class="module-arrow">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
            ...
            <div class="module-card" @click="navigateToModule('/admin/clients')">
              ...
              <div class="module-content">
                ...
                <div class="module-stats">
                  <span>{{ dashboardStats.totalClients }} clientes registrados</span>
                </div>
              </div>
              <div class="module-arrow">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
            ...
            <div class="module-card" @click="navigateToModule('/admin/ecommerce-config')">
              ...
              <div class="module-content">
                ...
                <div class="module-stats">
                  <span>Umbral automático configurado</span>
                </div>
              </div>
              <div class="module-arrow">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
            ...
            <div class="module-card" @click="navigateToModule('/admin/audit-logs')">
              ...
              <div class="module-content">
                ...
                <div class="module-stats">
                  <span>{{ dashboardStats.auditLogs }} registros recientes</span>
                </div>
              </div>
              <div class="module-arrow">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
...
// Datos del dashboard - enfocados en administración del sistema
...
// Verificar que el usuario sea administrador al cargar
onMounted(() => {
